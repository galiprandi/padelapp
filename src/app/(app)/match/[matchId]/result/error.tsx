...
export default function MatchResultError({
  error,
  reset,
}: {
    ...
    <div className="flex flex-col items-center justify-center gap-4 py-16 text-center px-4 max-w-md mx-auto min-h-[60vh]">
      ...
      <div className="space-y-1">
        <h1 className="text-lg font-bold text-foreground">
          No pudimos cargar la carga de resultado
        </h1>
        <p className="text-sm text-muted-foreground max-w-xs">
          Ocurrió un problema al procesar los datos de este partido. Podés reintentar o volver al partido.
        </p>
      </div>
