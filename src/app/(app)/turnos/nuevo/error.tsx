...
export default function NewTurnError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("New turn error:", error);
  }, [error]);
    ...
    <div className="flex flex-col items-center justify-center gap-4 py-16 text-center px-4 max-w-md mx-auto min-h-[60vh]">
      ...
      <div className="space-y-1">
        <h1 className="text-lg font-bold text-foreground">
          No pudimos cargar el formulario de nuevo turno
        </h1>
        <p className="text-sm text-muted-foreground max-w-xs">
          Ocurrió un problema al preparar la creación de un nuevo turno. Podés reintentar o volver a los turnos.
        </p>
      </div>
